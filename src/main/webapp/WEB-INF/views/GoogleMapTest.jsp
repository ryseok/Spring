...
.map_wrap {position:relative;width:100%;height:700px;} /*Map Size 조절*/
...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=키 발급&libraries=services"></script>
<script>
